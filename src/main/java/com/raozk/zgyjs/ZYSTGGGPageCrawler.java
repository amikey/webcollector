 ...
 */
@Component
public class ZYSTGGGPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(ZYSTGGGPageCrawler.class);
    ...
    public void process(Page page) {
        page.addTargetRequests(page.getHtml().links().regex("http://www\\.ttybk\\.com/zgyjs/list\\.asp\\?id=3&Page=\\d+").all());
