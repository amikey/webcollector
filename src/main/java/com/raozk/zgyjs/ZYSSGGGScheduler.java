 ...
 */
@Component
public class ZYSSGGGScheduler implements BaseSchduler {

    private static Logger logger = LoggerFactory.getLogger(ZYSSGGGScheduler.class);

    @Resource(type = ZYSSGGGPageCrawler.class)
