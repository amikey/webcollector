 ...
 */
@Component
public class JMJShengGouGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(JMJShengGouGongGaoPageCrawler.class);
