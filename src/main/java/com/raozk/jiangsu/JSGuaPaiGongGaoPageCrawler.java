 ...
 */
@Component
public class JSGuaPaiGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(JSGuaPaiGongGaoPageCrawler.class);
    ...
    static {
        startUrls.add("http://ybk.jscaee.com.cn/announcement/listing/");
    }
