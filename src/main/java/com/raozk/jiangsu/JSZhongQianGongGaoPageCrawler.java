 ...
 */
@Component
public class JSZhongQianGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(JSZhongQianGongGaoPageCrawler.class);
    ...
    static {
        startUrls.add("http://ybk.jscaee.com.cn/announcement/lottery-winnings/");
    }
