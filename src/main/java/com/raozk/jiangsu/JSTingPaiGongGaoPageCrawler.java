 ...
 */
@Component
public class JSTingPaiGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(JSTingPaiGongGaoPageCrawler.class);
    ...
    static {
        startUrls.add("http://ybk.jscaee.com.cn/announcement/suspension/");
    }
