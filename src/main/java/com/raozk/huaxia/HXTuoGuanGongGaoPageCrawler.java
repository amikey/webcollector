 ...
 */
@Component
public class HXTuoGuanGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(HXTuoGuanGongGaoPageCrawler.class);
    ...
    static {
        startUrls.add("http://www.huaxiacae.com/notice/tggg/");
    }
