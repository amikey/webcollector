 ...
 */
@Component
public class FLTSGGGPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(FLTSGGGPageCrawler.class);
    ...
    static {
        startUrls.add("http://dzp.wjybk.com/?action-category-catid-127");
    }
