 ...
 */
@Component
public class ShangShiGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(ShangShiGongGaoPageCrawler.class);
    ...
    private static String type = "上市公告";


    static {
        startUrls.add("http://dzp.wjybk.com/?action-category-catid-124");
    }
