 ...
 */
@Component
public class FLTZXPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(FLTZXPageCrawler.class);
    ...
    static {
        startUrls.add("http://dzp.wjybk.com/?action-hyzx");
        startUrls.add("http://dzp.wjybk.com/?action-category-catid-130");
        startUrls.add("http://dzp.wjybk.com/?action-category-catid-8");
    }
