 ...
 */
@Component
public class ZhongQianGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(ZhongQianGongGaoPageCrawler.class);
    ...
    static {
        startUrls.add("http://dzp.wjybk.com/?action-category-catid-128");
    }
