 ...
 */
@Component
public class FLTTGGGPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(FLTTGGGPageCrawler.class);
    ...
    static {
        startUrls.add("http://dzp.wjybk.com/?action-category-catid-126");
    }
