 ...
 */
@Component
public class JiaoYiGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(JiaoYiGongGaoPageCrawler.class);
    ...
    private static String type = "交易公告";


    static {
        startUrls.add("http://dzp.wjybk.com/?action-category-catid-2");
    }
