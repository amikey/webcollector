 ...
 */
@Component
public class ZNTongZhiGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(ZNTongZhiGongGaoPageCrawler.class);
