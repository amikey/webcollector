 ...
 */
@Component
public class ZNShengGouGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(ZNShengGouGongGaoPageCrawler.class);
