 ...
 */
@Component
public class TuoGuanGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(TuoGuanGongGaoPageCrawler.class);
    ...
    private static String type = "1";//托管公告


    static {
        startUrls.add("http://www.zgqbyp.com/web/news/109.html");
    }
