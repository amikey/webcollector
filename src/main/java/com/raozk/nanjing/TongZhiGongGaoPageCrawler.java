 ...
 */
@Component
public class TongZhiGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(TongZhiGongGaoPageCrawler.class);
    ...
    private static String type = "3";//通知公告


    static {
        startUrls.add("http://www.zgqbyp.com/web/news/10.html");
    }
