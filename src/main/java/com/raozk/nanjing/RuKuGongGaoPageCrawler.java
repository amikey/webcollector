 ...
 */
@Component
public class RuKuGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(RuKuGongGaoPageCrawler.class);
    ...
    private static String type = "3";//入库公告


    static {
        startUrls.add("http://www.zgqbyp.com/web/news/111.html");
    }
