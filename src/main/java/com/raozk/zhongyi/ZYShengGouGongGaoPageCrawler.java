 ...
 */
@Component
public class ZYShengGouGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(ZYShengGouGongGaoPageCrawler.class);
    ...
    static {
        startUrls.add("http://www.cacecybk.com.cn/web/news/news.jsp?parentid=44&classid=56");
    }
