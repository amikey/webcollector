 ...
 */
@Component
public class NFTeShuGongGaoPageCrawler extends AbstractBaseCrawler {

    private static Logger logger = LoggerFactory.getLogger(NFTeShuGongGaoPageCrawler.class);
    ...
    private static String type = "特殊公告";


    static {
        startUrls.add("http://www.nfqbyp.com/infomation.html?newsTypeID=16829&newsType=%E7%89%B9%E6%AE%8A%E5%85%AC%E5%91%8A");
    }
